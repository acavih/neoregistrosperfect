import Resource from 'newbackend/src/models/Resource'
import Partner from 'newbackend/src/models/Partner'
import Attention from 'newbackend/src/models/Attention'
import { connectDb } from 'newbackend/src/utils/connect-db'
