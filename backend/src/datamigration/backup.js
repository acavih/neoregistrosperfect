require('./registrosback-master/models/Resource')
const { connectDB } = require('./registrosback-master/utils/connect-db.js')
const Partner = require('./registrosback-master/models/Members')
const Atencion = require('./registrosback-master/models/Atencion')
/** miembro
 * {
